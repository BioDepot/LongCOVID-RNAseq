...
class OWTrimgalore(OWBwBWidget):
    ...
    inputs = [("inputFiles",str,"handleInputsinputFiles"),("basenames",str,"handleInputsbasenames"),("trigger",str,"handleInputstrigger"),("outputDir",str,"handleInputsoutputDir"),("trigger2",str,"handleInputstrigger2")]
