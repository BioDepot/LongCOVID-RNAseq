...
class OWsalmon(OWBwBWidget):
    ...
    inputs = [("transcriptome",str,"handleInputstranscriptome"),("alignmentfiles",str,"handleInputsalignmentfiles"),("outputfiles",str,"handleInputsoutputfiles"),("gtffile",str,"handleInputsgtffile"),("trigger",str,"handleInputstrigger"),("outputdir",str,"handleInputsoutputdir")]
