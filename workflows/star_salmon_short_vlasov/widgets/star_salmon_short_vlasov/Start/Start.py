...
class OWStart(OWBwBWidget):
    ...
    outputs = [("work_dir",str),("genome_dir",str),("genome_file",str),("annotation_file",str),("genomegtfURLs",str),("bypass_star_index",str),("starversion",str),("transcriptomefile",str),("raw_genome_file",str),("raw_annotation_file",str),("download_dir",str),("trimmedfastqfiles",str),("trimmeddir",str),("fastqfiles",str),("s3bucket",str),("s3directory",str),("s3downloaddir",str),("alignedfiles",str),("aligneddir",str),("trimmedfiles",str),("fastqdir",str),("tablesDir",str),("srrids",str),("salmondir",str)]
    ...
    def handleOutputs(self):
        ...
        outputValue=None
        if hasattr(self,"srrids"):
            outputValue=getattr(self,"srrids")
        self.send("srrids", outputValue)
        outputValue=None
